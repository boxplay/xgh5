<template>
  <div class="main" v-show="imgList">
		<!-- 完整信息图片 -->
		<div class="hdld">
			<img :src="imgList.xgPlayTitle" alt="">
		</div>
		<!-- 完整信息图片结束 -->
    <!-- 轮播图开始 -->
    <div>
      <swiper :options="swiperOption">
		...
		<!-- 信息展示 -->
		<div class="hdld">
			<img :src="imgList.xgPlayDesc" alt="">
		</div>
		<!-- 信息展示 -->
    <!-- 轮播图结束 -->
    <div class="hdld">
		...
		<!-- 信息展示 -->
		<div class="hdld">
			<img :src="imgList.xgPlayHdldBack" alt="">
		</div>
		<!-- 信息展示 -->
		<!-- 邮轮亮点开始 -->
		<div class="hdld">
		...
		<div class="ylld">
			<div class="ylld-list" v-for="item in imgList.xgPlayYlld">
				<img :src="item" alt="">
			</div>
		</div>
		<!-- 邮轮亮点结束 -->
		<!-- 信息展示 -->
		<div class="hdld">
			<img :src="imgList.xgPlayYlldBack" alt="">
		</div>
		<!-- 信息展示 -->
		<!-- 活动概览开始 -->
		<!-- <div class="hdgl">
		...
		<!-- 信息展示 -->
		<div class="hdld">
			<img :src="imgList.xgPlayHdrcBack" alt="">
		</div>
		<!-- 信息展示 -->
		<!-- 规则和日程 -->
		<div class="hdgl">
		...
		<div class='people'>
			<div class="people-box" v-for="item in imgList.xgPlayCz">
		...
		<!-- 合作商bannner -->
		<div>
			<img width="100%" :src="imgList.xgPlayHzBanner">
		</div>
		<!-- 合作商<banner></banner> -->
		...
		<!-- 合作伙伴LOGO -->
		<div>
			<img width="100%" :src="imgList.xgPlayHzLogo">
		</div>
		<!-- 合作伙伴 -->
		<!-- 信息展示 -->
		<div class="hdld">
			<img :src="imgList.xgPlayHzLogoBack" alt="">
		</div>
		<!-- 信息展示 -->
		<!-- 联系方式 -->
		<div class="hdld">
...
<style scoped>
	...
	@import '../mob/assets/css/index.css'
